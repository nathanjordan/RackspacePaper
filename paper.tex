...
\lstdefinelanguage{JavaScript}{
  ...
  stringstyle=\color{goldfishOrange}\ttfamily,
  morestring=[b]',
  morestring=[b]"
}
...
\DeclareCaptionFont{capB}{\usefont{OT1}{phv}{b}{n}\small}
\DeclareCaptionFont{cap}{\usefont{OT1}{phv}{m}{n}\small}
\captionsetup[lstlisting]{labelfont=capB,textfont=cap}

\captionsetup[figure]{labelfont=capB,textfont=cap}
...
\preauthor{\begin{flushleft}\large \lineskip 0.5em \usefont{OT1}{phv}{b}{n} \color{goldfishOrange}} % Author font configuration

\author{Nathan Jordan } % Your name

\postauthor{\footnotesize \usefont{OT1}{phv}{m}{n} \color{dark-gray} % Configuration for the institution name
